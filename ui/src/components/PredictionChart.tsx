    ...
    <div className="space-y-2">
      <ResponsiveContainer width="100%" height={160}>
        <LineChart data={chartData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
          ...
          <Line type="monotone" dataKey="Bull" stroke="#2EE6A8" strokeWidth={1.5} dot={false}
            strokeDasharray="4 2" activeDot={{ r: 3 }} />
          <Line type="monotone" dataKey="Base" stroke="#8055F5" strokeWidth={2} dot={false}
            activeDot={{ r: 3 }} />
          <Line type="monotone" dataKey="Bear" stroke="#FF5C7A" strokeWidth={1.5} dot={false}
            strokeDasharray="4 2" activeDot={{ r: 3 }} />
